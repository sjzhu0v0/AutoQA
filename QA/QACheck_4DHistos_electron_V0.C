...
//
///    root.exe -l -b -q
///    QACheck_4DHistos_electron_V0.C'("LHC23h_pass3_QC/AnalysisResults_LHC23h_pass3_NewNN.root")'
///
//===========================================================================================================================================
...
void QACheck_4DHistos_electron_V0(const char *inputFile, TString outputFile) {
  output = outputFile;
  LoadLibs();
  SetupStyle();
  ...
  for (Int_t i = 0; i < 2; i++) {
    ...
    h2->SaveAs(output +
               Form("h_nSigmaTPC_vs_Eta__TPCnCls_%.1f_%.1f__%s_V0_NewNN.png",
  ...
  for (Int_t i = 0; i < 2; i++) {
    ...
    h1->SaveAs(output +
               Form("h_nSigmaTPC_vs_pT__TPCnCls_%.1f_%.1f__%s_V0_NewNN.png",
                    fix_TPCnCls_Min, fix_TPCnCls_Max, particlename.c_str()));
